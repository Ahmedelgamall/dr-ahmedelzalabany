...
@section('title', getTranslatedWords('testimonials'))
@section('css')
...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">{{ getTranslatedWords('home') }} /</span>
            {{ getTranslatedWords('testimonials') }}</h4>
        ...
        <div class="card">
            ...
            {{-- <h5 class="card-header">{{getTranslatedWords('testimonials')}}</h5> --}}
    ...
    <div class="modal fade" id="delete" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="post" action="{{ route('testimonials.destroy', 0) }}">
                    @csrf
                    @method('delete')
