...
@section('title', getTranslatedWords('edit branch'))
@section('css')
...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">{{ getTranslatedWords('home') }} /</span>
            {{ getTranslatedWords('edit branch') }}</h4>

        <div class="row">
            <div class="col-md-12">

                <div class="card mb-4">
                    <h5 class="card-header">{{ getTranslatedWords('edit branch') }}</h5>
                    <!-- Account -->

                    <hr class="my-0" />
                    <div class="card-body">
                        <form enctype="multipart/form-data" id="formAccountSettings" method="POST"
                            action="{{ route('branches.update',$row->id) }}">
                            @csrf
                            @method('put')
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="tel" value="{{ $row->phone_1 }}" class="form-control" name="phone_1"
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="tel" value="{{ $row->phone_2 }}" class="form-control" name="phone_2"
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="url" value="{{ $row->location_url }}" class="form-control" name="location_url"
