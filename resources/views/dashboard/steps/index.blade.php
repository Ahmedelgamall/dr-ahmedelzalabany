...
@section('title', getTranslatedWords('steps'))
@section('css')
...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            {{-- <h5 class="card-header">{{getTranslatedWords('steps')}}</h5> --}}
    ...
    <div class="modal fade" id="delete" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="post" action="{{ route('steps.destroy', 0) }}">
                    @csrf
                    @method('delete')
