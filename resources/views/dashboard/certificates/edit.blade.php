...
@section('title', getTranslatedWords('edit certificate'))
@section('css')
...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">{{ getTranslatedWords('home') }} /</span>
            {{ getTranslatedWords('edit certificate') }}</h4>

        <div class="row">
            <div class="col-md-12">

                <div class="card mb-4">
                    <h5 class="card-header">{{ getTranslatedWords('edit certificate') }}</h5>
                    <!-- Account -->

                    <hr class="my-0" />
                    <div class="card-body">
                        <form enctype="multipart/form-data" id="formAccountSettings" method="POST"
                            action="{{ route('certificates.update',$row->id) }}">
                            @csrf
                            @method('put')
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="mb-3 col-md-6">
                                    @component('components.input_trans', [
                                        'type' => 'textarea',
                                        'label' => getTranslatedWords('opinion'),
                                        'required' => 'true',
                                        'model' => $row,
                                    ])
                                        opinion
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    @endif
                                    {{ getTranslatedWords('image') }} 370 * 370
