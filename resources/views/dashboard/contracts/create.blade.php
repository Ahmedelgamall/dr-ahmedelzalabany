...
@section('title', getTranslatedWords('add contract'))
@section('css')
...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card mb-4">
                <h5 class="card-header">{{ getTranslatedWords('add contract') }}</h5>
                <!-- Account -->

                <hr class="my-0" />
                <div class="card-body">
                    <form enctype="multipart/form-data" id="formAccountSettings" method="POST" action="{{ route('contracts.store') }}">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                {{ getTranslatedWords('image') }} 300 * 100
