    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card mb-4">
                ...
                <hr class="my-0" />
                <div class="card-body">
                    <form enctype="multipart/form-data" id="formAccountSettings" method="POST" action="{{ route('blogs.store') }}">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" value="{{ old('title') }}" class="form-control" name="title" placeholder="{{ getTranslatedWords('title') }}">
                                @error('title')
                            ...
                            @foreach (getLanguages() as $lang)
                            <select name="meta_keywords:{{ $lang }}[]" class="select2 form-control" multiple id=""></select>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select name="meta_keywords[]" class="select2 form-control" multiple id=""></select>
