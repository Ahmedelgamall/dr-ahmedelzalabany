...
class ServicesController extends Controller
{
    ...
    {
        $this->middleware('cando:list services')->only('index');
        $this->middleware('cando:add service')->only(['store']);
        $this->middleware('cando:edit service')->only(['update']);
        $this->middleware('cando:delete service')->only('destroy');
    }
            ...
            return Datatables::of($query)
                ...
                ->addColumn('action', function ($query) {
                    ...
                    if (auth()->user()->can('edit service')) {
                        $edit = ' <a class="dropdown-item" href="' . route('services.edit', $query->id) . '""
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.services.edit')->with(compact('row'));
    }
    ...
    public function destroy($id)
    {
        $row = Service::findOrFail($id);
        $row->delete();
        return redirect()->to(route('services.index'))->with('success', getTranslatedWords('deleted successfully'));
