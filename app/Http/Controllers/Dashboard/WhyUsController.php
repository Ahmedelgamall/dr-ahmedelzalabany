...
class WhyUsController extends Controller
{
    ...
    {
        $this->middleware('cando:list why choose us')->only('index');
        $this->middleware('cando:add why choose us')->only(['store']);
        $this->middleware('cando:edit why choose us')->only(['update']);
        $this->middleware('cando:delete why choose us')->only('destroy');
    }
