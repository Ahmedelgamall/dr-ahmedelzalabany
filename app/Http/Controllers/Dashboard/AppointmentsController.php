...
class AppointmentsController extends Controller
{
    ...
    {
        $this->middleware('cando:list appointments')->only(['index']);
        $this->middleware('cando:delete appointment')->only(['destroy']);
    }
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            return Datatables::of($query)
                ...
                ->editColumn('radians_type', function ($query) {
                    return $query->type;
                })
                ...
                ->editColumn('date', function ($query) {
                    return $query->date.' '.getTranslatedWords(''.$query->time);
                })
    ...
    public function destroy($id)
    {
        ...
        return redirect()->to(route('appointments.index'))->with('success', getTranslatedWords('deleted successfully'));
